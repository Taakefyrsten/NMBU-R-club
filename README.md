# NMBU-R-club <a href="https://www.nmbu.no/en/research/projects/rovquant"><img src="figures/Rclub.png" align="right" height="180"/></a>

<h4 align="center">

This is the open repository of the NMBU R-club.
A space to collect resources related to instructing students in R and other content related to the R-club project.
...
# [Register your problem here! (R-club issue tracker️)](https://forms.gle/mQKUt7KE2DjyY9ew6)
...
- [R-club on canvas](https://nmbu.instructure.com/courses/8870)
- [R-club on facebook page](https://www.facebook.com/groups/1398638660751995/)
...
Below are a few links to useful resources. These include tips on how to load your data in R, how to manipulate your data and format it according to your needs, how to visualize it in different ways,...

## Loading data
When working in Rstudio, you can load your data files in your R session using different methods:
